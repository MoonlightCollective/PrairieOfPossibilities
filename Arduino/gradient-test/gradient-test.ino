...
void loop() {
  ...
  fill_solid(top, top.size(), ColorFromPalette(myPal, 255));
  fill_palette_circular(side1, side1.size(), 0, myPal,255,LINEARBLEND,false);
  fill_palette_circular(side2, side2.size(), 0, myPal,255,LINEARBLEND,true);
