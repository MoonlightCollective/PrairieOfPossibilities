...
namespace OxOD
{
    public class FileDialog : MonoBehaviour
    {
        ...
        public TMPro.TMP_Text windowName;
        public TMPro.TMP_InputField currentPath;
        ...
        public IEnumerator Open(string path = null, string allowedExtensions = null, string windowName = "OPEN FILE", Sprite windowIcon = null, long maxSize = -1, bool saveLastPath = true)
        {
            ...
            commit.GetComponentInChildren<TMPro.TMP_Text>().text = "OPEN";
            fileName.text = "";
            fileName.transform.Find("FileText").GetComponent<TMPro.TMP_Text>().text = "FILE NAME:";
            workingPath = "";
            workingFile = "";
            result = null;
            finished = false;
        ...
        public IEnumerator Save(string path = null, string allowedExtensions = null, string windowName = "SAVE FILE", Sprite windowIcon = null, bool saveLastPath = true)
        {
            ...
            commit.GetComponentInChildren<TMPro.TMP_Text>().text = "SAVE";
            fileName.text = "";
            fileName.transform.Find("FileText").GetComponent<TMPro.TMP_Text>().text = "FILE NAME:";
            workingPath = "";
            workingFile = "";
        ...
        public IEnumerator SelectFolder(string path = null, string windowName = "SELECT FOLDER", Sprite windowIcon = null, bool saveLastPath = true)
        {
            ...
            commit.GetComponentInChildren<TMPro.TMP_Text>().text = "SELECT";
            fileName.text = "";
            fileName.transform.Find("FileText").GetComponent<TMPro.TMP_Text>().text = "FOLDER NAME:";
            workingPath = "";
            workingFile = "";
            result = null;
            finished = false;
